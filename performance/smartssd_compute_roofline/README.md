...
II=1。主循环使用 free-running pipeline，避免 320 路展开时产生高扇出的全局
clock-enable/stall 网络。seed 和最终 checksum 均通过 AXI-Lite 控制寄存器传递，设计中没有全局内存
...
./smartssd_peak_compute \
  -x build_dir.hw.xilinx_u2_gen3x4_xdma_gc_2_202110_1.l320.mbank0.f300.frp/peak_compute.xclbin \
...
265.9 MHz，但默认 stallable pipeline 又产生了扇出为7360的循环使能路径；当前
free-running 实现继续针对该路径进行优化。
