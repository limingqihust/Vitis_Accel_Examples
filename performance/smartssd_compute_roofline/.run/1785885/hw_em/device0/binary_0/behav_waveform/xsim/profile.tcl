...
proc getTraceEvents {kernelName cuName moduleName signal targetValue {requireEnd 0}} {
  ...
  set startTimeMsec 0
  set factor 9.0
  set currDeviceName xilinx_u2_gen3x4_xdma_gc_2_202110_1-0
  set currBinaryName peak_compute.link
...
# Compute Unit Stalls
#
set computeUnits { peak_compute_1 }
set cuFullPaths { /pfm_top_wrapper/pfm_top_i/pfm_dynamic_inst/peak_compute_1/inst/ }
...
# Function Stalls
#
set computeUnits { peak_compute_1 peak_compute_1 }
set cuFullPaths { /pfm_top_wrapper/pfm_top_i/pfm_dynamic_inst/peak_compute_1/inst/ /pfm_top_wrapper/pfm_top_i/pfm_dynamic_inst/peak_compute_1/inst/ }
set modules { grp_peak_compute_Pipeline_load_seeds_fu_133 grp_peak_compute_Pipeline_compute_fu_147 }
set realModules { peak_compute_Pipeline_load_seeds peak_compute_Pipeline_compute }
...
# Set list of CU, modules, protoinst for kernel peak_compute at index 0 in " kernels " list declared later 
set cuForKernel0 { peak_compute_1  } 
set cuPathForKernel0 { /pfm_top_wrapper/pfm_top_i/pfm_dynamic_inst/peak_compute_1/inst/  } 
set moduleForKernel0 { grp_peak_compute_Pipeline_load_seeds_fu_133 grp_peak_compute_Pipeline_compute_fu_147  } 
set protoInstForKernel0 { grp_peak_compute_Pipeline_load_seeds_fu_133 grp_peak_compute_Pipeline_compute_fu_147  } 

set kernels { peak_compute }
